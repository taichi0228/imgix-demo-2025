...
function ImageParamsEditor({ defaultParams, originalCode, onParamsChange }: ImageParamsEditorProps) {
  ...
  return (
    <div className="bg-gray-800 p-4 rounded-lg">
      <h3 className="text-white text-lg font-medium mb-2">Imgix Parameters Editor</h3>
      <p className="text-gray-300 text-sm mb-4">
        {t ? t('editor_intro') : 'Edit the parameters below to see real-time changes to the images. Uncomment lines by removing // to enable those parameters.'}
      </p>
